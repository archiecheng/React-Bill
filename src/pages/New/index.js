    ...
    <div className="keepAccounts">
      ...
      <div className="header">
        <div className="kaType">
          <Button shape="rounded" className={billType === 'pay' ? 'selected' : ''} onClick={() => setBillType('pay')}>
            支出
          </Button>
          <Button className={billType === 'income' ? 'selected' : ''} shape="rounded" onClick={() => setBillType('income')}>
            收入
          </Button>
        </div>
